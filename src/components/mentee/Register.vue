        ...
        <div class="col-md-6">
            ...
            <form @submit.prevent="submit">
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" v-model="mentee.password.password" placeholder="Password" required />
              </div>
              <div class="form-group">
                <label>Confirm Password</Label>
                <input type="password" class="form-control" v-model="mentee.password.confirm" placeholder="Confirm Password" required />
              </div>
