        ...
        <div class="row gy-4 gy-md-0">
          <div
            ...
            <div style="max-width: 650px">
              ...
              <a class="btn btn-outline-primary btn-lg" role="button" href="#">See Our Works</a>
            </div>
          </div>
          <div class="col-md-6">
            <div class="pb-5 mb-5">
    ...
    <div class="bg-primary-gradient" style="height: 420px">
      <div class="container gy-4 gy-md-0">
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-6">
              <div class="card-body py-lg-5" style="
                  width: 315px;
                  padding-right: 33px;
        ...
        <div class="row row-cols-1 row-cols-md-2">
          <div class="col">
            ...
            <h2 style="margin-bottom: 0px; font-size: 34px">
              Embark on your career journey<br /><strong><span
                  style="color: rgb(33, 33, 33)">GetMentored</span></strong>
              is with you always along your path
            </h2>
            <img class="rounded fit-cover" style="min-height: 150px; background: #fafafa; height: 851.39px"
              src="@/assets/img/Graphic.png" width="636" height="1028" />
          </div>
          <div class="col">
            <div class="row">
                ...
                <div class="card mx-md-5" style="border-radius: 35px">
                  <div class="card-body px-4 py-5 px-md-5">
                    <div>
                      ...
                      <p class="text-muted">
                        <span style="color: rgb(34, 34, 34)">Connect with mentors and training tools along the
                ...
                <div class="card mx-md-5" style="border-radius: 35px">
                  <div class="card-body px-4 py-5 px-md-5">
                    <div>
                      ...
                      <p class="text-muted">
                        <span style="color: rgb(34, 34, 34)">From building a profile to building the experience
                ...
                <div class="card mx-md-5" style="border-radius: 35px">
                  <div class="card-body px-4 py-5 px-md-5">
                    <div>
                      ...
                      <p class="text-muted">
                        <span style="color: rgb(34, 34, 34)">Along with the personalized Mentoring, GetMentored
      ...
      <div class="row mb-5">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
          ...
          <p class="w-lg-50" style="font-size: 25px">
            <span style="color: rgb(51, 51, 51)">Experts join GetMentored from some of the world’s most trusted
              institutions</span>
          </p>
        </div>
      </div>
