...
<template>
  <div class="row justify-content-center">
        ...
        <div class="row gy-4 gy-md-0">
          ...
          >
            <div style="max-width: 650px">
              <h2
                class="text-uppercase fw-bold font-color"
                style="font-family: Poppins, sans-serif; font-size: 46px"
              >
    ...
    <div class="bg-primary-gradient" style="height: 420px">
            ...
            <div class="col-md-6">
              ...
              >
                <div>
                  ...
                  <router-link to="/mentee-register" tag ="button" class="btn btn-outline-primary" style="border-radius: 20px; color: #fde69a">Become a Mentee</router-link>
                  <!-- <button
            ...
            <div class="col-md-6">
              ...
              >
                <div>
                  ...
                  <router-link to="/mentor-register" tag ="button" class="btn btn-outline-primary" style="border-radius: 20px; color: #fde69a">Become a Mentor</router-link>
                  <!-- <button
                    class="btn btn-primary"
                    type="button"
                    style="border-radius: 20px; color: #1e266d"
      ...
      <div class="container py-4 py-xl-5" style="background: #fafafa">
        <div class="row row-cols-1 row-cols-md-2">
          <div class="col">
            <p style="color: #a5a5a5">OUR SERVICES</p>
            <h2 style="margin-bottom: 0px; font-size: 34px">
              Embark on your career journey<br /><strong
                ><span style="color: rgb(33, 33, 33)">GetMentored</span></strong
              >
              is with you always along your path
            </h2>
            <img
              class="rounded fit-cover"
              style="min-height: 150px; background: #fafafa; height: 851.39px"
                    ...
                    <div>
                      ...
                      <p class="text-muted">
                        <span style="color: rgb(34, 34, 34)"
                          >Connect with mentors and training tools along the
                          way. &nbsp;From profile strategies, résumés and a
                ...
                <div class="card mx-md-5" style="border-radius: 35px">
                  <div class="card-body px-4 py-5 px-md-5">
                    <div>
                      ...
                      <p class="text-muted">
                        <span style="color: rgb(34, 34, 34)"
                          >From building a profile to building the experience
                          needed through volunteering and additional training
                          GetMentored has tools and resources for your career
                          journey. &nbsp;We understand that you grow,
                          reconsider, and career plans pivot.&nbsp;&nbsp;</span
                        >
                      </p>
                      <router-link to="/Career" tag="button" class="btn btn-primary" style="border-radius: 20px; color: #1e266d">Learn More</router-link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card mx-md-5" style="border-radius: 35px">
                  <div class="card-body px-4 py-5 px-md-5">
                    <div>
                      ...
                      <p class="text-muted">
                        <span style="color: rgb(34, 34, 34)"
                          >Along with the personalized Mentoring, GetMentored
    ...
    <!-- End: Hero2 -->
      ...
      <div class="row mb-5">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
          <h2 style="font-size: 34px">Meet your favorite Mentors</h2>
          <p class="w-lg-50" style="font-size: 25px">
            <span style="color: rgb(51, 51, 51)"
              >Experts join GetMentored from some of the world’s most trusted
              institutions</span
            >
          </p>
        </div>
        ...
        <div class="col">
          <div class="card shadow">
            ...
            <div class="card-body p-4">
              ...
              <p class="card-text">
                <span style="color: rgb(51, 51, 51)"
                  >16 years’ experience with domestic, foreign, and luxury cars
                  and heavy equipment.</span
                ><br />
              </p>
              <div class="d-flex">
                <img
